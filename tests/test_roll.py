...
def get_max_roll_result(input_tensor: np.ndarray, shifts, dims) -> np.ndarray:
...
def test_roll(RTOL, init_np_tensor, shifts, dims):
    # Test parameters
    batch_size = 2
    seq_length = 3
    channels = 4
    ...
    # MAX implementation
    max_output = get_max_roll_result(input_tensor, shifts, dims)
